...
/** Autogenerated input type of CreateSubscriptionWithOverride */
export type CreateSubscriptionWithOverrideInput = {
  billingTime: BillingTimeEnum;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  customerId: Scalars['ID'];
  name?: InputMaybe<Scalars['String']>;
  overriddenPlanId: Scalars['ID'];
  plan: PlanInput;
  subscriptionId?: InputMaybe<Scalars['ID']>;
};
...
export type Mutation = {
  ...
  /** Create a new Subscription from parent plan */
  createSubscriptionWithOverride?: Maybe<Subscription>;
  /** Deletes an add-on */
...
export type MutationCreateSubscriptionWithOverrideArgs = {
  input: CreateSubscriptionWithOverrideInput;
};
...
export type CreateSubscriptionWithOverrideMutationVariables = Exact<{
  input: CreateSubscriptionWithOverrideInput;
}>;


export type CreateSubscriptionWithOverrideMutation = { __typename?: 'Mutation', createSubscriptionWithOverride?: { __typename?: 'Subscription', id: string, status?: StatusTypeEnum | null, startedAt?: any | null, nextPendingStartDate?: any | null, name?: string | null, nextName?: string | null, externalId: string, periodEndDate?: any | null, plan: { __typename?: 'Plan', id: string, name: string, code: string }, nextPlan?: { __typename?: 'Plan', id: string, name: string, code: string } | null } | null };
...
export type SubscriptionItemFragment = { __typename?: 'Subscription', id: string, name?: string | null, periodEndDate?: any | null, externalId: string };
...
export const VolumeRangesFragmentDoc = gql`
  ...
  volumeRanges {
    ...
    `;
export const OverridePlanFragmentDoc = gql`
...
export const GetPlanOverrideDocument = gql`
...
/**
 * __useGetPlanOverrideQuery__
 *
 * To run a query within a React component, call `useGetPlanOverrideQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPlanOverrideQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPlanOverrideQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetPlanOverrideQuery(baseOptions: Apollo.QueryHookOptions<GetPlanOverrideQuery, GetPlanOverrideQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPlanOverrideQuery, GetPlanOverrideQueryVariables>(GetPlanOverrideDocument, options);
      }
export function useGetPlanOverrideLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPlanOverrideQuery, GetPlanOverrideQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPlanOverrideQuery, GetPlanOverrideQueryVariables>(GetPlanOverrideDocument, options);
        }
export type GetPlanOverrideQueryHookResult = ReturnType<typeof useGetPlanOverrideQuery>;
export type GetPlanOverrideLazyQueryHookResult = ReturnType<typeof useGetPlanOverrideLazyQuery>;
export type GetPlanOverrideQueryResult = Apollo.QueryResult<GetPlanOverrideQuery, GetPlanOverrideQueryVariables>;
...
export const CreateSubscriptionWithOverrideDocument = gql`
  ...
  createSubscriptionWithOverride(input: $input) {
    ...
    ${CustomerSubscriptionListFragmentDoc}`;
export type CreateSubscriptionWithOverrideMutationFn = Apollo.MutationFunction<CreateSubscriptionWithOverrideMutation, CreateSubscriptionWithOverrideMutationVariables>;

/**
 * __useCreateSubscriptionWithOverrideMutation__
 *
 * To run a mutation, you first call `useCreateSubscriptionWithOverrideMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateSubscriptionWithOverrideMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createSubscriptionWithOverrideMutation, { data, loading, error }] = useCreateSubscriptionWithOverrideMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateSubscriptionWithOverrideMutation(baseOptions?: Apollo.MutationHookOptions<CreateSubscriptionWithOverrideMutation, CreateSubscriptionWithOverrideMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateSubscriptionWithOverrideMutation, CreateSubscriptionWithOverrideMutationVariables>(CreateSubscriptionWithOverrideDocument, options);
      }
export type CreateSubscriptionWithOverrideMutationHookResult = ReturnType<typeof useCreateSubscriptionWithOverrideMutation>;
export type CreateSubscriptionWithOverrideMutationResult = Apollo.MutationResult<CreateSubscriptionWithOverrideMutation>;
export type CreateSubscriptionWithOverrideMutationOptions = Apollo.BaseMutationOptions<CreateSubscriptionWithOverrideMutation, CreateSubscriptionWithOverrideMutationVariables>;
