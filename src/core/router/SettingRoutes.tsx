...
export const DO_NOT_USE_INTEGRATIONS_ROUTE = `${SETTINGS_ROUTE}/integrations/`
export const INTEGRATIONS_ROUTE = `${SETTINGS_ROUTE}/integrations/:integrationGroup`
...
export const GOCARDLESS_INTEGRATION_OAUTH_CALLBACK_ROUTE = `${DO_NOT_USE_INTEGRATIONS_ROUTE}/gocardless/callback`
