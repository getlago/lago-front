...
type AvailableFeeTypes = {
  [FeeTypesEnum.Charge]: FeeTypesEnum.Charge
  [FeeTypesEnum.Commitment]: FeeTypesEnum.Commitment
  [FeeTypesEnum.Subscription]: FeeTypesEnum.Subscription
}

const availableFeeTypesTranslation: Record<keyof AvailableFeeTypes, string> = {
          ...
          <div className="flex flex-wrap items-center gap-3">
            {formikProps.values.appliesTo?.feeTypes?.map((feeType) => {
              const feeTypeTranslation =
                availableFeeTypesTranslation[feeType as keyof AvailableFeeTypes]
