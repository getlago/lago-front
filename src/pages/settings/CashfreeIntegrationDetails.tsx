...
import Cashfree from '~/public/images/cashfree-large.svg'
...
const CashfreeIntegrationDetails = () => {
  ...
  // const isConnectionEstablished = !!cashfreePaymentProvider?.webhookSecret
                ...
                {canEditIntegration && (
                  <>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        window.open(
                          `${lagoOauthProxyUrl}/cashfree/auth?lago_name=${cashfreePaymentProvider.name}&lago_code=${cashfreePaymentProvider.code}`,
                        )
                        closePopper()
                      }}
                    >
                  ...
                  <Item direction="row" alignItems="center" justifyContent="space-between">
                    <Stack direction="row" alignItems="center" spacing={3}>
                      ...
                      <Stack direction="column">
                        ...
                        <Typography variant="body" color="grey700">
                          {cashfreePaymentProvider.webhookSecret}
                        </Typography>
                      </Stack>
                    </Stack>
                    <Tooltip title={translate('text_6360ddae753a8b3e11c80c66')} placement="top-end">
                      <Button
                        variant="quaternary"
                        onClick={() => {
                          copyToClipboard(cashfreePaymentProvider?.webhookSecret as string)
                          addToast({
                            severity: 'info',
