...
import { useDeleteEntraIdIntegrationDialog } from '../DeleteEntraIdIntegrationDialog'
...
const defaultIntegration = {
  id: 'entra-id-integration-123',
  name: 'Test Entra ID Integration',
}
...
describe('DeleteEntraIdIntegrationDialog', () => {
  beforeAll(async () => {
