...
import { formatCodeFromName, updateNameAndMaybeCode } from '~/core/utils/updateNameAndMaybeCode'
import {
  FeatureObject,
                ...
                <section className="not-last-child:mb-6">
                  ...
                  <div className="flex flex-col gap-6 *:flex-1">
                    {formikProps.values.privileges.map((privilege, privilegeIndex) => (
                      <FeaturePrivilegeAccordion
                        key={`privilege-accordion-${privilegeIndex || privilege.code}`}
                        isEdition={isEdition}
                        privilege={privilege}
                        ...
                        setPrivilegeName={(value: string) => {
                          const hasCodeBeenTouched =
                            !!formikProps.touched.privileges?.[privilegeIndex]?.code
                          const hadInitialCode =
                            !!formikProps.initialValues.privileges?.[privilegeIndex]?.code

                          formikProps.setFieldValue(`privileges.${privilegeIndex}`, {
                            ...formikProps.values.privileges[privilegeIndex],
                            name: value,
                            code:
                              hasCodeBeenTouched || hadInitialCode
                                ? formikProps.values.privileges[privilegeIndex].code
                                : formatCodeFromName(value),
                          })
                        }}
