...
import ProductItemFilterValuesEditor, {
  buildProductItemFilterComboBoxData,
...
describe('ProductItemFilterValuesEditor', () => {
  ...
  describe('buildProductItemFilterComboBoxData', () => {
    it('emits a parent-key option (no value) followed by one option per value', () => {
      const data = buildProductItemFilterComboBoxData([FILTERS[0]], [])
    ...
    it('disables the individual value options once the parent key is selected', () => {
      const data = buildProductItemFilterComboBoxData(FILTERS, [
        { billableMetricFilterId: 'bmf-1', value: undefined },
      ])
