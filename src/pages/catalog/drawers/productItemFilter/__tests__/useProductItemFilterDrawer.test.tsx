...
describe('useProductItemFilterDrawer', () => {
  ...
  it('opens the drawer with the create title, form id and content', () => {
    const { result } = renderHook(() => useProductItemFilterDrawer())
    ...
    expect(openArgs.title).toBe('text_17836220307039rf790f045t')
    expect(openArgs.form?.id).toBe('product-item-filter-drawer-form')
