...
export type ProductFilterValueEntry = {
...
export const buildProductFilterComboBoxData = (
  billableMetricFilters: Array<Pick<BillableMetricFilter, 'id' | 'key' | 'values'>>,
  values: ProductFilterValueEntry[],
): BasicComboBoxData[] => {
...
const ProductFilterValuesEditor = ({
  billableMetricFilters,
  values,
  onChange,
  disabled,
  hasError,
}: ProductFilterValuesEditorProps) => {
  ...
  const comboBoxData: BasicComboBoxData[] = useMemo(
    () => buildProductFilterComboBoxData(billableMetricFilters, values),
...
export default ProductFilterValuesEditor
