...
const RateCardDrawerFormSections = withForm({
  ...
  render: function RateCardDrawerFormSectionsRender({
    ...
    const [
      getProductFilters,
      { data: productFiltersData, loading: productFiltersLoading },
    ] = useGetProductFiltersForRateCardDrawerLazyQuery()
    ...
    const selectedProductMeta = productId
      ? productMetaById.get(productId)
      : undefined
    ...
    const isProrationVisible =
      !!selectedProductMeta &&
      (selectedProductMeta.productType === ProductTypeEnum.Fixed ||
        selectedProductMeta.recurring)
