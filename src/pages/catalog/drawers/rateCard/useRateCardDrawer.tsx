...
const useRateCardForm = ({ onSuccess }: { onSuccess: (result: RateCardFormSuccess) => void }) => {
          ...
          variables: {
            input: {
              ...
              ...(value.productFilterId
                ? { productFilterId: value.productFilterId }
                : {}),
  ...
  const resetForm = (
    ...
    const seededProductId =
      attachToProductFilter?.product.id ?? attachToProduct?.id ?? ''
...
export const useRateCardDrawer = () => {
  ...
  const openDrawer = ({
    ...
    const productSource =
      rateCard?.product ?? attachToProductFilter?.product ?? attachToProduct
