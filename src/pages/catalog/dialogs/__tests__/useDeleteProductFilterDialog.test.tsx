...
const productFilterFixture: ProductFilterForDeleteProductFilterDialogFragment = {
  id: 'pifilter-1',
  name: 'Region',
}
    ...
    <button
      ...
      onClick={() =>
        openDeleteProductFilterDialog({
          productFilter: productFilterFixture,
          callback,
        })
      }
    >
...
describe('useDeleteProductFilterDialog', () => {
  afterEach(() => {
    cleanup()
    jest.clearAllMocks()
  })
  ...
  it('destroys the filter, evicts it, runs the callback and toasts', async () => {
    ...
    renderDialog(
      [
        deleteProductFilterMock(
          { data: { destroyProductFilter: { id: 'pifilter-1' } } },
          capturedVariables,
        ),
      ],
      callback,
