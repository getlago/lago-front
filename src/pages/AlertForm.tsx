                ...
                <section className="not-last-child:mb-6">
                  ...
                  <div className="flex flex-col gap-6 *:flex-1">
                    <ComboBoxField
                      ...
                      // TODO: Data misses one option, not added on BE yet
                      data={[
                        {
                    ...
                    {!!formikProps.values.alertType && (
                      <>
                        {/* TODO: This should also include the other missiong option, so you can select the billable metric */}
                        {formikProps.values.alertType ===
                          ...
                          <>
                            ...
                            {!formikProps.values.billableMetricId && <>TODO: add table content</>}
                          </>
                        )}
