...
export const WebhookLogDetails = ({ log }: WebhookLogDetailsProps) => {
  ...
  return (
    <>
      <Typography
        className="hidden items-center justify-between px-4 py-2 shadow-b md:flex"
        variant="bodyHl"
        color="textSecondary"
      >
        {webhookType}
      ...
      <div className="flex flex-col gap-12 p-4">
        <div className="grid grid-cols-[140px,_1fr] items-baseline gap-3 pb-12 shadow-b">
          ...
          <div className="flex items-center gap-2">
            ...
            {hasError && <Status {...statusWebhookMapping(status)} />}
          </div>
        ...
        {response && hasError && (
          <div className="flex flex-col gap-2 pb-12 shadow-b">
            <Typography variant="subhead" color="grey700">
              {translate('text_1746623729674lo13y0oatk9')}
            </Typography>

            <div className="overflow-hidden rounded-lg bg-grey-100">
              <CodeSnippet
        ...
        <div className="flex flex-col gap-2 pb-12">
          ...
          <div className="overflow-hidden rounded-lg bg-grey-100">
            <div className="flex items-center justify-end bg-grey-200 p-2">
              <Button variant="quaternary" icon="duplicate" size="small" />
            </div>
            <CodeSnippet
              className="h-[calc(100%-52px)]"
              language="json"
