// Devtools route constants
// This file contains only route constants with no other imports to avoid circular dependencies.
// Both DevtoolsRouter.tsx and useDeveloperTool.tsx can safely import from here.
