...
import {
  ...
  FeatureEntitlementPrivilegeForSubscriptionFragmentDoc,
...
gql`
  # Please make sure to update the FeatureEntitlementForSubscription fragment when updating the FeatureEntitlementForPlan fragment
  # TODO:
  fragment FeatureEntitlementForSubscription on Subscription {
    entitlements {
      code
      name
      privileges {
        ...FeatureEntitlementPrivilegeForSubscription
      }
    }
  }
        ...
        <div className="flex items-center justify-between gap-4 rounded-lg bg-grey-100 px-6 py-4">
          <Box>
            <Typography variant="bodyHl" color="textSecondary">
              {translate('text_1753864223060kmmxk4a59aj')} <Icon name="sparkles" />
            </Typography>
