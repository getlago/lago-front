...
export const useDeletePlanDialog = () => {
  ...
  const openDeletePlanDialog = ({ plan, callback }: OpenDeletePlanDialogData) => {
    ...
    centralizedDialog.open({
      title: translate('text_625fd165963a7b00c8f59797', { planName: name }),
