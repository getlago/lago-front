...
gql`
  # Please make sure to update the FeatureEntitlementPrivilegeForSubscription fragment when updating the FeatureEntitlementPrivilegeForPlan fragment
  fragment FeatureEntitlementPrivilegeForSubscription on SubscriptionEntitlementPrivilegeObject {
    code
    name
    value
    valueType
...
> = ({ formikProps, entitlement, isCreatingPlan }) => {
  ...
  const { data: featureDetailsData, loading: featureDetailsLoading } =
    useGetFeatureDetailsForFeatureEntitlementPrivilegeSectionQuery({
      variables: {
        // TODO: Need to be code: featureCode
                      ...
                      ? {
                          ...
                          privileges: [
                            ...(entitlementForUpdate.privileges || []),
                            {
                              ...
                              value: '', // Value is set to null by default, this is a valid value for the Backend
                            },
                          ],
                        }
                      : entitlementForUpdate,
...
const PrivilegeValueInputComponent: FC<{
