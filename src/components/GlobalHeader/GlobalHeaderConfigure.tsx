...
import { useGlobalHeaderWriter } from './GlobalHeaderContext'
 ...
 */
function configSnapshot(config: GlobalHeaderConfig): string {
...
/**
 * Declarative zero-render component that configures the GlobalHeader.
 ...
 * from consumer pages.
 */
export const GlobalHeaderConfigure: FC<GlobalHeaderConfig> = (props) => {
  const { setConfig, resetConfig, registerConfigure, unregisterConfigure } = useGlobalHeaderWriter()
