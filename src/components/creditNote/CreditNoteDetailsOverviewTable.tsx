  ...
  return (
    <section
      className={tw(
        ...
        '[&>table>tfoot>tr>td]:py-3 [&>table>tfoot>tr>td]:text-right',
        '[&>table>tfoot>tr>td:nth-child(1)]:w-1/2 [&>table>tfoot>tr>td:nth-child(2)]:w-[35%] [&>table>tfoot>tr>td:nth-child(2)]:text-left [&>table>tfoot>tr>td:nth-child(2)]:shadow-b [&>table>tfoot>tr>td:nth-child(3)]:w-[15%] [&>table>tfoot>tr>td:nth-child(3)]:shadow-b [&>table>tfoot>tr>td:nth-child(3)]:line-break-anywhere',
      )}
    >
      {children}
    </section>
