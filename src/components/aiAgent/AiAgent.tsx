...
import { objectCreationPaths, settingsObjectCreationPaths } from '~/core/router'
...
export const AiAgent = () => {
  ...
  const match =
    matchRoutes(objectCreationPaths, location) || matchRoutes(settingsObjectCreationPaths, location)
