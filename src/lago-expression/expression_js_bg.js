...
export function parseExpression(expression) {
    try {
        ...
        wasm.parseExpression(retptr, ptr0, len0);
 ...
 * @returns {any}
 */
export function evaluateExpression(expression, code, timestamp, js_properties) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(expression, Expression);
        var ptr0 = expression.__destroy_into_raw();
        const ptr1 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.evaluateExpression(retptr, ptr0, ptr1, len1, timestamp, addBorrowedObject(js_properties));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
