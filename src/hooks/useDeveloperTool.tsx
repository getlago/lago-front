...
// This pattern mirrors setAuthErrorHandler in init.ts, allowing logout handlers
// to reset devtools state without needing access to the React context.
let devtoolsResetHandler: (() => void) | null = null

export const setDevtoolsResetHandler = (handler: () => void) => {
  devtoolsResetHandler = handler
}
