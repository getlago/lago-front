...
describe('validateChargeProperties Graduated', () => {
  describe('properties', () => {
    describe('invalid', () => {
      it('has undefined graduatedRange', () => {
        const result = validate(ChargeModelEnum.Graduated, { graduatedRanges: undefined }, [
          'properties',
        ])
      ...
      it('has empty graduatedRange', () => {
        const result = validate(ChargeModelEnum.Graduated, { graduatedRanges: [] }, ['properties'])
  ...
  describe('filters (same validation, different path prefix)', () => {
    describe('invalid', () => {
      ...
      it('has empty graduatedRange', () => {
        const result = validate(ChargeModelEnum.Graduated, { graduatedRanges: [] }, [
          'filters',
          '0',
          'properties',
        ])
