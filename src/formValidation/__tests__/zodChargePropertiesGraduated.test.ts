...
describe('validateChargeProperties Graduated', () => {
  describe('properties', () => {
    describe('invalid', () => {
      it('has undefined graduatedRange', () => {
        const result = validate('graduated', { graduatedRanges: undefined }, ['properties'])

        expect(result.isValid).toBe(false)
      })
      it('has empty graduatedRange', () => {
        const result = validate('graduated', { graduatedRanges: [] }, ['properties'])
      ...
      it('has wrong perUnitAmount', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '0', toValue: '100', perUnitAmount: 'a', flatAmount: '1' },
            ],
          },
          ['properties'],
        )
      ...
      it('has wrong flatAmount', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '0', toValue: '100', perUnitAmount: '1', flatAmount: 'a' },
            ],
          },
          ['properties'],
        )
      ...
      it('has wrong perUnitAmount and flatAmount', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '0', toValue: '100', perUnitAmount: 'a', flatAmount: 'a' },
            ],
          },
          ['properties'],
        )
      ...
      it('has empty perUnitAmount and empty flatAmount', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '0', toValue: '100', perUnitAmount: '', flatAmount: '' },
            ],
          },
          ['properties'],
        )
    ...
    describe('valid', () => {
      ...
      it('has valid range with only perUnitAmount filled', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '1', toValue: '100', perUnitAmount: '1', flatAmount: '' },
            ],
          },
          ['properties'],
        )
      ...
      it('has valid range with only flatAmount filled', () => {
        const result = validate(
          ...
          {
            graduatedRanges: [
              { fromValue: '1', toValue: '100', perUnitAmount: '', flatAmount: '1' },
            ],
          },
          ['properties'],
        )
  ...
  describe('filters (same validation, different path prefix)', () => {
    describe('invalid', () => {
      it('has undefined graduatedRange', () => {
        const result = validate('graduated', { graduatedRanges: undefined }, [
          'filters',
          '0',
          'properties',
        ])
      ...
      it('has empty graduatedRange', () => {
        const result = validate('graduated', { graduatedRanges: [] }, [
          'filters',
          '0',
          'properties',
        ])
