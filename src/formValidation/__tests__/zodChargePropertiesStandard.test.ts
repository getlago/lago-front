...
describe('validateChargeProperties Standard', () => {
  describe('properties', () => {
    describe('invalid', () => {
      it('has empty string amount', () => {
        const result = validate('standard', { amount: '' }, ['properties'])

        expect(result.isValid).toBe(false)
      })

      it('has invalid string amount', () => {
        const result = validate('standard', { amount: 'a' }, ['properties'])
    ...
    describe('valid', () => {
      it('has string amount', () => {
        const result = validate('standard', { amount: '1' }, ['properties'])
  ...
  describe('filters (same validation, different path prefix)', () => {
    describe('invalid', () => {
      it('has empty string amount', () => {
        const result = validate('standard', { amount: '' }, ['filters', '0', 'properties'])

        expect(result.isValid).toBe(false)
      })

      it('has invalid string amount', () => {
        const result = validate('standard', { amount: 'a' }, ['filters', '0', 'properties'])
    ...
    describe('valid', () => {
      it('has string amount', () => {
        const result = validate('standard', { amount: '1' }, ['filters', '0', 'properties'])
