...
describe('validateChargeProperties Volume', () => {
  describe('properties', () => {
    describe('invalid', () => {
      it('has undefined volumeRange', () => {
        const result = validate('volume', { volumeRanges: undefined }, ['properties'])

        expect(result.isValid).toBe(false)
      })
      it('has empty volumeRange', () => {
        const result = validate('volume', { volumeRanges: [] }, ['properties'])
  ...
  describe('filters (same validation, different path prefix)', () => {
    describe('invalid', () => {
      it('has undefined volumeRange', () => {
        const result = validate('volume', { volumeRanges: undefined }, [
          'filters',
          '0',
          'properties',
        ])
      ...
      it('has empty volumeRange', () => {
        const result = validate('volume', { volumeRanges: [] }, ['filters', '0', 'properties'])
